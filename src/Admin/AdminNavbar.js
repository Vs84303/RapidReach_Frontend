...
function AdminNavbar() {
  ...
  return (
    <div>
      <Navbar variant="dark" expand="lg" className="px-5" style={{ border: '2px solid black',backgroundColor:"yellow" }}>
        <Container fluid>
        <Navbar.Brand as={NavLink} to="/admin/addbranch" className="d-flex align-items-center text-decoration-none">
        <span style={{color:"red", fontSize:"2.0rem"}}>
          RapidReach
        </span>
      </Navbar.Brand>
